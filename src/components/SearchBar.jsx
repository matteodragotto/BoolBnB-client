  ...
  return (
    ...
    <>
      ...
      <div className="flex items-center space-x-4 bg-gray-100 p-4 shadow-lg ">
        <form class="max-w-md flex mx-auto">
          ...
          <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-100 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cerca appartamenti da affittare..." required value={searchData} onChange={(e) => setSearchData(e.target.value)} />
            <button type="submit" class="text-white absolute end-2.5 bottom-2.5 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2"><Link
              onClick={() => searchApartments(selectedCountry)}
              to="/search"
            >
              Cerca
